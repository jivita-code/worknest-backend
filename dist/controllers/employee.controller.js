...
export const createEmployee = async (req, res, next) => {
    try {
        ...
        const { employee_number, first_name, last_name, email, password, phone, designation, employment_type, join_date, dep_id, } = req.body;
        ...
        if (join_date)
            employeeData.join_date = new Date(join_date);
        if (dep_id)
            employeeData.dep_id = dep_id;
...
export const updateEmployee = async (req, res, next) => {
    try {
        ...
        const { employee_number, first_name, last_name, email, password, phone, designation, employment_type, join_date, status, dep_id, } = req.body;
        ...
        if (employee_number !== undefined)
            employeeData.employee_number = employee_number;
        ...
        if (employment_type !== undefined)
            employeeData.employment_type = employment_type;

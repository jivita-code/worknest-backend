...
describe("Department Controller - createDepartment", () => {
  ...
  it("should create a department successfully with only required fields", async () => {
    ...
    (departmentService.createDepartment as jest.Mock).mockResolvedValue(mockDepartment);

    await createDepartment(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  it("should call next with error if service throws", async () => {
    ...
    (departmentService.createDepartment as jest.Mock).mockRejectedValue(error);

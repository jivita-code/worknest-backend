...
describe("Department Controller - getAllDepartments", () => {
  ...
  it("should return all departments successfully", async () => {
    ...
    (departmentService.getAllDepartments as jest.Mock).mockResolvedValue(mockDepartments);

    await getAllDepartments(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  it("should call next with error if service throws", async () => {
    ...
    (departmentService.getAllDepartments as jest.Mock).mockRejectedValue(error);

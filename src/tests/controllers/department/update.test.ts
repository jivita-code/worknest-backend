...
import { updateDepartment } from "../../../controllers/department.controller.js";
...
describe("Department Controller - updateDepartment", () => {
  ...
  it("should update department name successfully", async () => {
    ...
    (departmentService.updateDepartment as jest.Mock).mockResolvedValue(mockDepartment);

    await updateDepartment(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  it("should call next with error if service throws", async () => {
    ...
    (departmentService.updateDepartment as jest.Mock).mockRejectedValue(error);

...
describe("updateOrganizationPassword", () => {
  ...
  beforeEach(() => {
    ...
    next = jest.fn();
    (orgService.updateOrganizationPassword as jest.Mock).mockReset();
  });
  ...
  test("should update password successfully", async () => {
    ...
    (orgService.updateOrganizationPassword as jest.Mock).mockResolvedValue(updatedOrg);

    await updateOrganizationPassword(req as Request, res as Response, next);

    expect(orgService.updateOrganizationPassword).toHaveBeenCalledWith(
  ...
  test("should call next on service error", async () => {
    ...
    (orgService.updateOrganizationPassword as jest.Mock).mockRejectedValue(error);
